...
def train_defect_model(
    ...
    """Fit a logistic regression on labelled sessions.

    Returns a JSON-serialisable model dict, or None if there isn't enough signal
    (too few labels, only one class, or sklearn unavailable) — callers then fall
...
__all__ = [
    ...
    "predict_defect_risk", "MIN_LABELS",
]
